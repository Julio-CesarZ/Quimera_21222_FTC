// Versão de rotas: esquerda da aliança azul
...
@Autonomous(name = "Left_Blue")
public class Autonomous_ULTRA_Poggers_Left_Blue extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (!isStopRequested() && opModeIsActive()) {
            ...
            if (recognitions.size() > 0) {
                ...
                // Garantir que a rota esquerda seja executada.
        ...
        while (sair >= 1) {
            ...
            if (aprilTag.getDetections().size() > 0) {
                ...
                for (AprilTagDetection detection : detections) {
                    if (detection.id == x) {
                        if (detection.ftcPose.x >= -3) {
                            while (detection.ftcPose.x >= -3) {
                                walk("right", 10, 0.3);
                                break;
                            }
